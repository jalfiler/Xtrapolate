...
def bridge(data_set):
    ...
    if data_set == "Sales":
        ...
        X_train, X_test, y_train, y_test = data_loader.split_data(target_y_column='SALES', target_x_columns=['ORDERDATE'], test_size=0.2)
...
def display():
    ...
    if request.method == 'POST':
        ...
        intercept, coefficients, ML_pred = regr.auto_reg_lin(X_train, y_train, X_test)
